...
CUDA_VISIBLE_DEVICES=0 "$python" dist_rep_sent_doc/hyperopt/pvdm.py concat imdb &
P1=$!
CUDA_VISIBLE_DEVICES=1 "$python" dist_rep_sent_doc/hyperopt/pvdm.py concat imdb &
P2=$!
wait $P1 $P2
